...
\begin{scope}
[gray, 
every node/.style={circle, draw, fill, inner sep=2pt}, very thick, 
weight/.style={rectangle, draw=none,fill=none, scale=0.3}]
...
\node (k4e3) at (0.8,-0.8) {};
\node (k4e4) at (-0.8,-0.8) {};
\draw (k4e1) --node[midway,weight,below]{$1$} (k4e2);
\draw (k4e2) --node[midway,weight,left]{$\frac{5-\sqrt{5}}{4}$} (k4e3);
\draw (k4e3) --node[midway,weight,above]{$1$} (k4e4);
