...
\node[rectangle, draw=none, fill=none, below=0.5cm] (spec.south) at (0,4) {weight Laplacian spectrum};
...
\node[draw=none] at (6,2) {
  \href{https://ilas2025.tw/}{
    \tikz\node[red!40!orange, draw=none, rectangle, align=center, scale=0.6] at (0,0) {allow ordered multiplicity list $(1,2,1)$\\but not spectrum $\{0,2^{(2)},5\}$};
  }
};
