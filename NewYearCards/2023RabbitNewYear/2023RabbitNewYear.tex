...
%%% RESIDUAL
\draw[-triangle 45] (-7,0) -- (7,0);
\draw[-triangle 45] (-4,3) -- (-4,4);
\draw[-triangle 45] (-4,0) arc (0:360:1);
...
\node[circle, draw, fill, inner sep=2pt, label={below:$2023$}] at (3,0) {};
\node[circle, draw, fill, inner sep=2pt, label={below:$2025$}] at (5,0) {};
