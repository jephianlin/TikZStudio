...
%%% RABBIT
\begin{scope}[yellow, very thick, shift={(-2,-2)}, every node/.style={circle, draw, inner sep=1pt}]
...
%%%ILAS2025
\node[rectangle, draw=none, yellow, below] (ILAS2025) at (3.5,3) {\LARGE \texttt{ILAS2025} in Kaohsiung!};
