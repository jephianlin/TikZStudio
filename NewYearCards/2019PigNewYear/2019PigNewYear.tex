...
\fill [blue!50] (-8,-4) rectangle (8,5);
%%SatanHeart
...
%%Happy New Math Year
%\draw[decorate,decoration={text along path,text={|\color{red!80!yellow} \LARGE \it|Happy New Math Year 2019}}] (-3.5,0.5) .. controls (-1,3.5) and (1,0.5) .. (3.5,3.5);
