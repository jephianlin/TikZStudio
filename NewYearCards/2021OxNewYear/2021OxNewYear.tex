...
\node[rectangle,draw=red,inner sep=0,below] at ([xshift=5cm]Cuba) {\includegraphics[scale=0.5]{127.png}};
\node[rectangle,draw=red,inner sep=0,below] at ([xshift=5cm]Cuba) {\includegraphics[scale=0.5]{511.png}};
